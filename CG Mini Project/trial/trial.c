...
float theta;
    ...
    {
        theta=i*3.14/180;
        glVertex2f(100+20*cos(theta),400+20*sin(theta));
    }
    for(int i=0;i<180;i++)
    {
        theta=i*3.14/180;
        glVertex2f(150+40*cos(theta),400+40*sin(theta));
    }
    for(int i=0;i<180;i++)
    {
        theta=i*3.14/180;
        glVertex2f(200+20*cos(theta),400+20*sin(theta));
    }
    glEnd();
    //cloud2
    glBegin(GL_POLYGON);
    ...
    {
        theta=i*3.14/180;
        glVertex2f(310+15*cos(theta),380+15*sin(theta));
    }
    for(int i=0;i<180;i++)
    {
        theta=i*3.14/180;
        glVertex2f(350+30*cos(theta),380+30*sin(theta));
    }
    for(int i=0;i<180;i++)
    {
        theta=i*3.14/180;
        glVertex2f(400+15*cos(theta),380+15*sin(theta));
    }
    glEnd();
    //sun
    float thetaa;
    ...
    {
        thetaa=i*3.14/180;
        glVertex2f(250+15*cos(thetaa),390+15*sin(thetaa));
    }
    glEnd();
    glFlush();
glPushMatrix();
